      ...
      <Animator duration={{ enter: 1 }}>
        ...
        >
          <source
            ...
            srcSet="/images/background-large.webp"
            type="image/webp"
          />
          <source
            media="(min-width:1280px)"
            srcSet="/images/background-large.jpg"
            type="image/jpeg"
          />
          <source
            media="(min-width:768px)"
            srcSet="/images/background-medium.webp"
            type="image/webp"
          />
          <source
            media="(min-width:768px)"
            srcSet="/images/background-medium.jpg"
            type="image/jpeg"
          />
          <source
            media="(max-width:767px)"
            srcSet="/images/background-small.webp"
            type="image/webp"
          />
          <img
