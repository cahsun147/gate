      ...
      <Animator combine manager="stagger" unmountOnEntered unmountOnDisabled>
        <div className="absolute inset-0 flex justify-center items-center p-2 md:p-4">
          ...
          >
            ...
            <LineMajor offset={0.1}> Initializing crypto knowledge base...</LineMajor>
            <LineMinor>Crypto knowledge base has been successfully initialized.</LineMinor>
            <LineMajor>Fetching community projects metadata...</LineMajor>
            <LineMinor offset={0.2}>Found {projectsCount} community projects registered.</LineMinor>
            <LineMajor>Fetching community resources metadata...</LineMajor>
            <LineMinor offset={0.2}>Found {resourcesCount} resources registered.</LineMinor>
